...
import com.wind.web.util.ListPaging;
...
//		model.addAttribute("totalListNum", ListPaging.totalListNum);
//		model.addAttribute("curNum", ListPaging.curNum);
//		model.addAttribute("curNowPageNum", ListPaging.curNowPageNum);
//		model.addAttribute("totalPageNum", ListPaging.totalPageNum);

		model.addAttribute("mylist", ListPaging.myListPageInfo);
		return "home";
	}
	...
	public void getPagesInfo() {
		IDao dao = sqlSession.getMapper(IDao.class);
		String num = dao.totalListNumDao();
		ListPaging.setTotalListNum(Integer.parseInt(num));
		ListPaging.setCurNum(12);
		ListPaging.viewPageInfo(); 
	}
