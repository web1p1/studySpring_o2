...
<P></P>
<LI><a href="${pageContext.request.contextPath}/petclinic/vetselect_view">Pet-Clinic 수의사 전공별 열람</a>
<LI><a href="${pageContext.request.contextPath}/petclinic/vet_add_view">수의사 등록</a>
